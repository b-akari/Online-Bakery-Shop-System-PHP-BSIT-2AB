...
<head>
	...
	<title>Soft Pretzel Details</title>
...
<body>
	...
	<div class="single-product">
		<div class="row">
			<div class="col-2">
				<img src="images\pretzel_pastry.png" width="100%">
			</div>
			<div class="col-2">
				<h1>Soft Pretzel</h1>
				<p>Traditional pretzels with a deeply browned exterior and a chewy texture.</p>
				<select>
