...
<head>
	...
	<title>Tiramisu Cake Details</title>
...
<body>
	...
	<div class="single-product nav-component">
		<div class="row">
			<div class="col-2">
				<img src="images\tiramisu_cake.png" width="100%">
			</div>
			<div class="col-2">
				<h1>Tiramisu Cake</h1>
				<p>A fusion of espresso-dipped ladyfingers and a creamy, lightly sweetened mascarpone cream, making a bittersweet result of flavors.</p>
				<select>
