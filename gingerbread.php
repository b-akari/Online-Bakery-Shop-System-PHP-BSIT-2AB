...
<head>
	...
	<title>Gingerbread Cookie Details</title>
...
<body>
	...
	<div class="single-product nav-component">
		<div class="row">
			<div class="col-2">
				<img src="images\gingerbread_cookie.png" width="100%">
			</div>
			<div class="col-2">
				<h1>Gingerbread Cookies</h1>
				<p>Molasses and brown sugar-sweetened holiday goodness that are crispy on the edges yet soft in the center.</p>
				<select>
