...
<head>
	...
	<title>Chocolate Cringles Details</title>
...
<body>
	...
	<div class="single-product">
		<div class="row">
			<div class="col-2">
				<img src="images\chococringles_cookie.png" width="100%">
			</div>
			<div class="col-2">
				<h1>Chocolate Crinkles</h1>
				<p>Brownie-like chocolate cookies coated in confectioners' sugar.</p>
				<select>
