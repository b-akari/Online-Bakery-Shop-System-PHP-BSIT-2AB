...
<head>
	...
	<title>Red Velvet Cake Details</title>
...
<body>
	...
	<div class="single-product nav-component">
		<div class="row">
			<div class="col-2">
				<img src="images\rvelvet_cake.png" width="100%">
			</div>
			<div class="col-2">
				<h1>Red Velvet Cake</h1>
				<p>Our own take on the traditional velvet flavor—vanilla drenched in butter with a hint of cocoa flavor.</p>
				<select>
